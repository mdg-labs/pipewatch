...
import { GITHUB_REPO_URL, getMarketingCta } from "@/lib/marketing-links";
    ...
    <section className="home-hero" aria-labelledby="home-hero-heading">
      <div className="home-hero-copy">
        ...
        <h1 id="home-hero-heading" className="home-hero-title">
          ...
          <span className="home-hero-title-accent"> all in one place</span>
        </h1>

        <p className="home-hero-subtitle">
          Live pipeline view across every repository.
          <br />
          Never tab-switch again.
        </p>
        ...
        <div className="home-hero-actions">
          ...
          <a
            ...
            className="home-hero-github-link"
            target="_blank"
            rel="noopener noreferrer"
            data-umami-event="home-cta-github"
            data-umami-event-location="hero"
          >
            <GitHubIcon />
            View on GitHub →
